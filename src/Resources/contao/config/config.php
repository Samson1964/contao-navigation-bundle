...
/*
 * Ab Contao 5.2 werden die Inserttags über das Attribut AsInsertTag registriert
...
if (!class_exists(AsInsertTag::class)) {
    ...
    $GLOBALS['TL_HOOKS']['replaceInsertTags'][] = [SeitennavigationInsertTag::class, 'doReplace'];
}
